# Project 4 - *TPM Instagram*

**TPM Instagram** is a photo sharing app using Parse as its backend.
...
- [z] User can tap a post to view post details, including timestamp and caption (+2pt)
